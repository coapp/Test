...
namespace Test.CoApp.Toolkit.Win32
{
    ...
    /// <summary>
    ///This is a test class for ModernSymlinkTest and is intended
    ///to contain all ModernSymlinkTest Unit Tests
    ///</summary>
    [TestClass()]
    public class ModernSymlinkTest
    {
        ...
        /// <summary>
        ///A test for ModernSymlink Constructor
        ///</summary>
        [TestMethod()]
        public void ModernSymlinkConstructorTest()
        {
            ModernSymlink target = new ModernSymlink();
        ...
        {
            ModernSymlink target = new ModernSymlink(); // TODO: Initialize to an appropriate value
